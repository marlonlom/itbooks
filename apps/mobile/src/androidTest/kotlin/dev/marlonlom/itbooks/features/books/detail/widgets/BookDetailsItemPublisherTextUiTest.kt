...
internal class BookDetailsItemPublisherTextUiTest {

  @get:Rule
  val composeTestRule = createComposeRule()

  @Test
  fun shouldDisplayPublisherText() {
    with(composeTestRule) {
      setContent {
        BookDetailsItemPublisherText(
      ...
      onNodeWithText("O'Reilly Media", true).assertIsDisplayed()
      onNodeWithText("Publisher", true).assertIsDisplayed()
    }
  }
}
