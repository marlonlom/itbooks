...
internal class BookDetailsItemRatingTextUiTest {
  ...
  @Test
  fun shouldDisplayZeroRatingText() {
    with(composeTestRule) {
      setContent {
        BookDetailsItemRatingText(
          detailsItem = bookDetail.copy(rating = 0),
        )
      }
      onNodeWithText("☆☆☆☆☆", true).assertIsDisplayed()
      onNodeWithText("Rating", true).assertIsDisplayed()
    }
  }

  @Test
  fun shouldDisplayOneRatingText() {
    with(composeTestRule) {
      setContent {
        BookDetailsItemRatingText(
          detailsItem = bookDetail.copy(rating = 1),
        )
      }
      onNodeWithText("★☆☆☆☆", true).assertIsDisplayed()
      onNodeWithText("Rating", true).assertIsDisplayed()
  ...
  @Test
  fun shouldDisplayTwoRatingText() {
    with(composeTestRule) {
      setContent {
        BookDetailsItemRatingText(
          detailsItem = bookDetail.copy(rating = 2),
        )
      }
      onNodeWithText("★★☆☆☆", true).assertIsDisplayed()
      onNodeWithText("Rating", true).assertIsDisplayed()
  ...
  @Test
  fun shouldDisplayThreeRatingText() {
    with(composeTestRule) {
      setContent {
        BookDetailsItemRatingText(
          detailsItem = bookDetail.copy(rating = 3),
        )
      }
      onNodeWithText("★★★☆☆", true).assertIsDisplayed()
      onNodeWithText("Rating", true).assertIsDisplayed()
  ...
  @Test
  fun shouldDisplayFourRatingText() {
    with(composeTestRule) {
      setContent {
        BookDetailsItemRatingText(
          detailsItem = bookDetail.copy(rating = 4),
        )
      }
      onNodeWithText("★★★★☆", true).assertIsDisplayed()
      onNodeWithText("Rating", true).assertIsDisplayed()
  ...
  @Test
  fun shouldDisplayFiveRatingText() {
    with(composeTestRule) {
      setContent {
        BookDetailsItemRatingText(
          detailsItem = bookDetail.copy(rating = 5),
        )
      }
      onNodeWithText("★★★★★", true).assertIsDisplayed()
      onNodeWithText("Rating", true).assertIsDisplayed()
