...
[IT-Books Code of Conduct](https://github.com/marlonlom/itbooks/blob/main/CODE_OF_CONDUCT.md).
...
Before you ask a question, it is best to search for existing [Issues](https://github.com/marlonlom/itbooks/issues) that
...
- Open an [Issue](https://github.com/marlonlom/itbooks/issues/new).
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there
  ...
  the [bug tracker](https://github.com/marlonlom/itbooks/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/marlonlom/itbooks/issues/new). (Since we can't be sure at this point whether it is
  a
...
This section guides you through submitting an enhancement suggestion for IT-Books, **including completely new features and
...
- Read the [documentation]() carefully and find out if the functionality is already covered, maybe by an individual
  configuration.
- Perform a [search](https://github.com/marlonlom/itbooks/issues) to see if the enhancement has already been suggested.
  If
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/marlonlom/itbooks/issues).
...
- **Explain why this enhancement would be useful** to most IT-Books users. You may also want to point out the other
